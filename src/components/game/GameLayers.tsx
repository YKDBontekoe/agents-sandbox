...
interface GameLayersProps {
  ...
  districts: District[];
  leylines: Leyline[];
  onLeylineSelect: (l: Leyline | null) => void;
...
export const GameLayers: React.FC<GameLayersProps> = ({
  hoverTile,
  selectedTile,
  tileTypes,
  placedBuildings,
  ...
  return (
    <>
      ...
      <LeylineSystem leylines={leylines} onLeylineCreate={() => {}} onLeylineSelect={onLeylineSelect} selectedLeyline={selectedLeyline} isDrawingMode={false} />
      ...
      <BuildingsLayer
        ...
        storeConnectedIds={connectedStore}
