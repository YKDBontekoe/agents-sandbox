  ...
  },
  {
    ...
    layout: {
      zones: {
        ...
        'top-right': { enabled: true, className: 'absolute top-4 right-4 z-40', maxPanels: 1, priority: 9 },
        'middle-left': { enabled: false, className: '' },
        'middle-center': { enabled: false, className: '' },
        'middle-right': { enabled: true, className: 'absolute right-4 top-1/2 -translate-y-1/2 z-40', maxPanels: 1, priority: 8 },
        'bottom-left': { enabled: false, className: '' },
        ...
        'bottom-right': { enabled: false, className: '' },
        'sidebar-left': { enabled: false, className: '' },
        'sidebar-right': { enabled: true, className: 'flex flex-col gap-1 p-2 h-full overflow-y-auto', maxPanels: 5, priority: 6 },
        'overlay': { enabled: true, className: 'absolute inset-0 z-50 pointer-events-none', priority: 11 }
      },
      responsive: {
        mobile: ['top-right', 'sidebar-right', 'overlay'],
        tablet: ['top-right', 'middle-right', 'sidebar-right', 'overlay'],
        desktop: ['top-right', 'middle-right', 'sidebar-right', 'overlay'],
        wide: ['top-right', 'middle-right', 'sidebar-right', 'overlay']
      }
    },
    panelConfigs: {
      'resources': { priority: 10, persistent: true },
  ...
  },
  {
    ...
    layout: {
      zones: {
        ...
        'bottom-right': { enabled: false, className: '' },
        'sidebar-left': { enabled: false, className: '' },
        'sidebar-right': { enabled: true, className: 'flex flex-col gap-1 p-2 h-full overflow-y-auto', maxPanels: 3, priority: 6 },
        'overlay': { enabled: true, className: 'absolute inset-0 z-50 pointer-events-none', priority: 11 }
      },
      responsive: {
        mobile: ['top-right', 'overlay'],
        tablet: ['top-right', 'sidebar-right', 'overlay'],
        desktop: ['top-right', 'sidebar-right', 'overlay'],
        wide: ['top-right', 'sidebar-right', 'overlay']
      }
    },
    panelConfigs: {
