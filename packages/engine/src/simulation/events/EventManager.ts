...
import type { ActiveEvent, VisualIndicator, SystemState, EventType, EventImpact } from './types';
...
export class EventManager {
  ...
  applyEventEffects(gameState: {
    ...
    buildingEffects: Array<{ buildingId: string; effects: BuildingEffect }>;
    citizenEffects: Array<{ citizenId: string; effects: CitizenEffect }>;
  } {
    const resourceChanges: Partial<SimResources> = {};
    const buildingEffects: Array<{ buildingId: string; effects: BuildingEffect }> = [];
    const citizenEffects: Array<{ citizenId: string; effects: CitizenEffect }> = [];
