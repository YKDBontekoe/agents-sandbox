...
- `src/components/game/city/` — city management panel subcomponents and config. Run `npm run lint src/components/game/CityManagementPanel.tsx src/components/game/city` when modifying
