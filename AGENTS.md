...
- `packages/engine/src/simulation/buildings/` — building catalog, maintenance, and utility modules. Run `npm test` and `npm run lint packages/engine/src/simulation` when modifying
